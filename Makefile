...
generate-requirements: uv.lock
	...
	uv tool run --with='pip<25.1' --with='pip-tools==7.4.1' 'pybuild-deps==0.4.1' compile --quiet --no-header --generate-hashes --output-file=requirements-build.txt requirements.txt
